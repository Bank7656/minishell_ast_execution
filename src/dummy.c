...
static void test_0(char **envp);
static void test_1(char **envp);
static void test_2(char **envp);
static void test_3(char **envp);
static void test_4(char **envp);
...
void  test(char **envp)
{
  printf("Basic commands test\n");
  printf("[Test 0]: ls -la\n");
  test_0(envp);
  printf("\n");
 
  printf("[Test 1]: cat -e dockerfile | cat -e | cat -e\n");
  test_1(envp);
  printf("\n");

  printf("Zombie process test\n");
  printf("[Test 2]: sleep 1 | sleep 3 | sleep 5\n");
  test_2(envp);
  printf("\n");
  printf("[Test 3]: sleep 1 | sleep 5 | sleep 3\n");
  test_3(envp);
  printf("\n");
  printf("[Test 4]: sleep 5 | sleep 3 | sleep 1\n");
  test_4(envp);
  printf("\n");
}
